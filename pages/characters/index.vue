<template>
  ...
  try {
    ...
    this.characters = response.data.characters; // Acceder al arreglo de personajes
    this.filteredCharacters = response.data.characters; // Inicialmente, mostramos todos
  } catch (error) {
